...
use mfsk::structs::demodulation::Demodulation as mfsk_demod;
use mfsk::structs::modulation::Modulation as mfsk_mod;
...
impl Demodulators {
    pub fn new(samples_per_symbol: usize, sample_rate: f32) -> Demodulators {
        Demodulators {
            ...
            mfsk: mfsk_demod::new(samples_per_symbol, sample_rate),
    ...
    pub fn update(&mut self, samples_per_symbol: usize, sample_rate: f32) {
        ...
        self.mfsk = mfsk_demod::new(samples_per_symbol, sample_rate);
...
impl Modulators {
    pub fn new(samples_per_symbol: usize, sample_rate: f32) -> Modulators {
        Modulators {
            ...
            mfsk: mfsk_mod::new(samples_per_symbol, sample_rate),
    ...
    pub fn update(&mut self, samples_per_symbol: usize, sample_rate: f32) {
        ...
        self.mfsk = mfsk_mod::new(samples_per_symbol, sample_rate);
