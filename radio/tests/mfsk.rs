...
//
//         TestData {
//             signal_1byte: mods.mfsk(BYTE_1),
//             signal_2bytes: mods.mfsk(BYTES_2),
//             signal_4bytes: mods.mfsk(BYTES_4),
//             signal_8bytes: mods.mfsk(BYTES_8),
//             signal_16bytes: mods.mfsk(BYTES_16),
//             signal_32bytes: mods.mfsk(BYTES_32),
//             signal_64bytes: mods.mfsk(BYTES_64),
//             signal_128bytes: mods.mfsk(BYTES_128),
//             signal_256bytes: mods.mfsk(BYTES_256),
//             signal_512bytes: mods.mfsk(BYTES_512),
//             signal_1024bytes: mods.mfsk(BYTES_1024),
//             signal_2048bytes: mods.mfsk(BYTES_2048),
//             instance: demods,
//         }
//
//     }
...
// #[test]
// pub fn mfsk_byte_1() {
//     let test = DATA.instance.mfsk(DATA.signal_1byte.clone());
//
//     let expected = BYTE_1;
//
//
...
//         test,
//         expected,
//         "Testing mfsk With 1 Byte of Data.\
//             Expected: {:?}\
//             Got: {:?}",
//         expected,
//         test
...
// #[test]
// pub fn mfsk_byte_2() {
//     let test = DATA.instance.mfsk(DATA.signal_2bytes.clone());
//
...
// #[test]
// pub fn mfsk_byte_4() {
//     let test = DATA.instance.mfsk(DATA.signal_4bytes.clone());
//
...
// #[test]
// pub fn mfsk_byte_8() {
//     let test = DATA.instance.mfsk(DATA.signal_8bytes.clone());
//
...
// #[test]
// pub fn mfsk_byte_16() {
//     let test = DATA.instance.mfsk(DATA.signal_16bytes.clone());
//
...
// #[test]
// pub fn mfsk_byte_32() {
//     let test = DATA.instance.mfsk(DATA.signal_32bytes.clone());
//
...
// #[test]
// pub fn mfsk_byte_64() {
//     let test = DATA.instance.mfsk(DATA.signal_64bytes.clone());
//
...
//
// #[test]
// pub fn mfsk_byte_128() {
//     let test = DATA.instance.mfsk(DATA.signal_128bytes.clone());
//
...
//
// #[test]
// pub fn mfsk_byte_256() {
//     let test = DATA.instance.mfsk(DATA.signal_256bytes.clone());
//
...
//
// #[test]
// pub fn mfsk_byte_512() {
//     let test = DATA.instance.mfsk(DATA.signal_512bytes.clone());
//
...
//
// #[test]
// pub fn mfsk_byte_1024() {
//     let test = DATA.instance.mfsk(DATA.signal_1024bytes.clone());
//
...
//
// #[test]
// pub fn mfsk_byte_2048() {
//     let test = DATA.instance.mfsk(DATA.signal_2048bytes.clone());
//
