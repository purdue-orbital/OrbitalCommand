...
fn bpsk_mod_1byte() { DATA.mods.bpsk(BYTE_1); }

fn bpsk_mod_2bytes() { DATA.mods.bpsk(BYTES_2); }

fn bpsk_mod_4bytes() { DATA.mods.bpsk(BYTES_4); }

fn bpsk_mod_8bytes() { DATA.mods.bpsk(BYTES_8); }

fn bpsk_mod_16bytes() { DATA.mods.bpsk(BYTES_16); }

fn bpsk_mod_32bytes() { DATA.mods.bpsk(BYTES_32); }

fn bpsk_mod_64bytes() { DATA.mods.bpsk(BYTES_64); }

fn bpsk_mod_128bytes() { DATA.mods.bpsk(BYTES_128); }

fn bpsk_mod_256bytes() { DATA.mods.bpsk(BYTES_256); }

fn bpsk_mod_512bytes() { DATA.mods.bpsk(BYTES_512); }

fn bpsk_mod_1024bytes() { DATA.mods.bpsk(BYTES_1024); }

fn bpsk_mod_2048bytes() { DATA.mods.bpsk(BYTES_2048); }


/// Demodulation benchmarks
fn bpsk_demod_1byte() { DATA.demods.bpsk(DATA.signal_1byte.clone()); }

fn bpsk_demod_2bytes() { DATA.demods.bpsk(DATA.signal_2bytes.clone()); }

fn bpsk_demod_4bytes() { DATA.demods.bpsk(DATA.signal_4bytes.clone()); }

fn bpsk_demod_8bytes() { DATA.demods.bpsk(DATA.signal_8bytes.clone()); }

fn bpsk_demod_16bytes() { DATA.demods.bpsk(DATA.signal_16bytes.clone()); }

fn bpsk_demod_32bytes() { DATA.demods.bpsk(DATA.signal_32bytes.clone()); }

fn bpsk_demod_64bytes() { DATA.demods.bpsk(DATA.signal_64bytes.clone()); }

fn bpsk_demod_128bytes() { DATA.demods.bpsk(DATA.signal_128bytes.clone()); }

fn bpsk_demod_256bytes() { DATA.demods.bpsk(DATA.signal_256bytes.clone()); }

fn bpsk_demod_512bytes() { DATA.demods.bpsk(DATA.signal_512bytes.clone()); }

fn bpsk_demod_1024bytes() { DATA.demods.bpsk(DATA.signal_1024bytes.clone()); }

fn bpsk_demod_2048bytes() { DATA.demods.bpsk(DATA.signal_2048bytes.clone()); }
