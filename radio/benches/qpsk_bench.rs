...
pub fn qpsk_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("qpsk mod 1 byte", |b| b.iter(qpsk_mod_1byte));
    c.bench_function("qpsk mod 2 bytes", |b| b.iter(qpsk_mod_2bytes));
    c.bench_function("qpsk mod 4 bytes", |b| b.iter(qpsk_mod_4bytes));
    c.bench_function("qpsk mod 8 bytes", |b| b.iter(qpsk_mod_8bytes));
    c.bench_function("qpsk mod 16 bytes", |b| b.iter(qpsk_mod_16bytes));
    c.bench_function("qpsk mod 32 bytes", |b| b.iter(qpsk_mod_32bytes));
    c.bench_function("qpsk mod 64 bytes", |b| b.iter(qpsk_mod_64bytes));
    c.bench_function("qpsk mod 128 bytes", |b| b.iter(qpsk_mod_128bytes));
    c.bench_function("qpsk mod 256 bytes", |b| b.iter(qpsk_mod_256bytes));
    c.bench_function("qpsk mod 512 bytes", |b| b.iter(qpsk_mod_512bytes));
    c.bench_function("qpsk mod 1024 bytes", |b| b.iter(qpsk_mod_1024bytes));
    c.bench_function("qpsk mod 2048 bytes", |b| b.iter(qpsk_mod_2048bytes));


    // Demodulators benchmarks
    c.bench_function("qpsk demod 1 byte", |b| b.iter(qpsk_demod_1byte));
    c.bench_function("qpsk demod 2 bytes", |b| b.iter(qpsk_demod_2bytes));
    c.bench_function("qpsk demod 4 bytes", |b| b.iter(qpsk_demod_4bytes));
    c.bench_function("qpsk demod 8 bytes", |b| b.iter(qpsk_demod_8bytes));
    c.bench_function("qpsk demod 16 bytes", |b| b.iter(qpsk_demod_16bytes));
    c.bench_function("qpsk demod 32 bytes", |b| b.iter(qpsk_demod_32bytes));
    c.bench_function("qpsk demod 64 bytes", |b| b.iter(qpsk_demod_64bytes));
    c.bench_function("qpsk demod 128 bytes", |b| b.iter(qpsk_demod_128bytes));
    c.bench_function("qpsk demod 256 bytes", |b| b.iter(qpsk_demod_256bytes));
    c.bench_function("qpsk demod 512 bytes", |b| b.iter(qpsk_demod_512bytes));
    c.bench_function("qpsk demod 1024 bytes", |b| b.iter(qpsk_demod_1024bytes));
    c.bench_function("qpsk demod 2048 bytes", |b| b.iter(qpsk_demod_2048bytes));
}
