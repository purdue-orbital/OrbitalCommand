...
fn ask_mod_1byte() {
    DATA.mods.ask(BYTE_1);
}

fn ask_mod_2bytes() {
    DATA.mods.ask(BYTES_2);
}

fn ask_mod_4bytes() {
    DATA.mods.ask(BYTES_4);
}

fn ask_mod_8bytes() {
    DATA.mods.ask(BYTES_8);
}

fn ask_mod_16bytes() {
    DATA.mods.ask(BYTES_16);
}

fn ask_mod_32bytes() {
    DATA.mods.ask(BYTES_32);
}

fn ask_mod_64bytes() {
    DATA.mods.ask(BYTES_64);
}

fn ask_mod_128bytes() {
    DATA.mods.ask(BYTES_128);
}

fn ask_mod_256bytes() {
    DATA.mods.ask(BYTES_256);
}

fn ask_mod_512bytes() {
    DATA.mods.ask(BYTES_512);
}

fn ask_mod_1024bytes() {
    DATA.mods.ask(BYTES_1024);
}

fn ask_mod_2048bytes() {
    DATA.mods.ask(BYTES_2048);
}

/// Demodulation benchmarks
fn ask_demod_1byte() {
    DATA.demods.ask(DATA.signal_1byte.clone());
}

fn ask_demod_2bytes() {
    DATA.demods.ask(DATA.signal_2bytes.clone());
}

fn ask_demod_4bytes() {
    DATA.demods.ask(DATA.signal_4bytes.clone());
}

fn ask_demod_8bytes() {
    DATA.demods.ask(DATA.signal_8bytes.clone());
}

fn ask_demod_16bytes() {
    DATA.demods.ask(DATA.signal_16bytes.clone());
}

fn ask_demod_32bytes() {
    DATA.demods.ask(DATA.signal_32bytes.clone());
}

fn ask_demod_64bytes() {
    DATA.demods.ask(DATA.signal_64bytes.clone());
}

fn ask_demod_128bytes() {
    DATA.demods.ask(DATA.signal_128bytes.clone());
}

fn ask_demod_256bytes() {
    DATA.demods.ask(DATA.signal_256bytes.clone());
}

fn ask_demod_512bytes() {
    DATA.demods.ask(DATA.signal_512bytes.clone());
}

fn ask_demod_1024bytes() {
    DATA.demods.ask(DATA.signal_1024bytes.clone());
}

fn ask_demod_2048bytes() {
    DATA.demods.ask(DATA.signal_2048bytes.clone());
}
